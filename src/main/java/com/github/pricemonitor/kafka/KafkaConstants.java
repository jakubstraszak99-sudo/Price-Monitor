...
public final class KafkaConstants {
    ...
    public static final String ALERT_NOTIFICATION_TOPIC = "alert-notification-topic";
    ...
    public static final String SCRAPER_SYNC_REPLY_TOPIC = "scraper-sync-reply-topic";
    ...
    public static final String SCRAPER_SYNC_REPLY_GROUP = "scraper-sync-reply-group";
